...
INSERT INTO POKEMON(NOMBRE, VITALIDAD, ATAQUE, DEFENSA, ATAQUE_ESP, DEFENSA_ESP, VELOCIDAD, ESTAMINA, NIVEL, MOVIMIENTOS, TIPO1, TIPO2)
VALUES('SNORLAX',481 ,330, 189, 149, 295, 96, 190, 100, '66,18,22,81 ', 'NORMAL', NULL);
INSERT INTO POKEMON(NOMBRE, VITALIDAD, ATAQUE, DEFENSA, ATAQUE_ESP, DEFENSA_ESP, VELOCIDAD, ESTAMINA, NIVEL, MOVIMIENTOS, TIPO1, TIPO2)
VALUES('ZAPDOS',384, 279, 269, 349, 278, 299, 200, 100, '58,59,41,78','ELECTRIC', 'NORMAL' );
INSERT INTO POKEMON(NOMBRE, VITALIDAD, ATAQUE, DEFENSA, ATAQUE_ESP, DEFENSA_ESP, VELOCIDAD, ESTAMINA, NIVEL, MOVIMIENTOS, TIPO1, TIPO2)
VALUES('STARMIE',324, 249, 269, 299, 269, 329, 185, 100, '6,67,5,79', 'WATER', 'PSYCHIC' );
INSERT INTO POKEMON(NOMBRE, VITALIDAD, ATAQUE, DEFENSA, ATAQUE_ESP, DEFENSA_ESP, VELOCIDAD, ESTAMINA, NIVEL, MOVIMIENTOS, TIPO1, TIPO2)
VALUES('RHYDON',414, 359, 339, 189, 189, 179, 178, 100, '40,22,38,36', 'GRASS', 'ROCK' );

INSERT INTO ENTRENADOR(NOMBRE, POKEMONS) VALUES('Knekro','1,2,3,4');
INSERT INTO ENTRENADOR(NOMBRE, POKEMONS) VALUES('Rivaldo','4,2,1,3');

INSERT TURNO(NUM_TURNO, MOVIMIENTO_JUGADOR, MOVIMIENTO_RIVAL) VALUES(1,66,79);
INSERT TURNO(NUM_TURNO, MOVIMIENTO_JUGADOR, MOVIMIENTO_RIVAL) VALUES(2,59,67);
INSERT TURNO(NUM_TURNO, MOVIMIENTO_JUGADOR, MOVIMIENTO_RIVAL) VALUES(3,36,5);

INSERT INTO COMBATE(JUGADOR, RIVAL, TURNOS) VALUES(1,2,'1,2,3');
